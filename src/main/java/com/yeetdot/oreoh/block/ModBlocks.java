...
import com.yeetdot.oreoh.energy.ElectricalProperties;
import com.yeetdot.oreoh.energy.ThermalProperties;
...
//    public static final Block BASIC_BATTERY = registerBlock("basic_battery", properties -> new BatteryBlock(properties, new EnergyStorageStats(100000, 2000)), BlockBehaviour.Properties.of());
    public static final Block COPPER_WIRE = registerBlock("copper_wire", properties -> new WireBlock(properties, new ElectricalProperties(100, 1e6), new ThermalProperties(300, 200, 10)), BlockBehaviour.Properties.of());
    public static final Block CREATIVE_GENERATOR = registerBlock("creative_generator", CreativeGeneratorBlock::new, BlockBehaviour.Properties.of());
