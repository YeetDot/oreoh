...
public class ModelProvider extends FabricModelProvider {
    ...
    public void generateBlockStateModels(BlockModelGenerators blockModelGenerators) {
        SetApplier.applyToMaterials(set -> blockModelGenerators.createTrivialCube(set.storageBlock));
        SetApplier.applyToMetals(set -> blockModelGenerators.createTrivialCube(set.rawBlock));
    ...
    public void generateItemModels(ItemModelGenerators itemModelGenerators) {
        ...
        SetApplier.applyToMaterials(set -> itemModelGenerators.generateFlatItem(set.primary, ModelTemplates.FLAT_ITEM));
        ...
        SetApplier.applyToAlloys(set -> itemModelGenerators.generateFlatItem(set.nugget, ModelTemplates.FLAT_ITEM));
